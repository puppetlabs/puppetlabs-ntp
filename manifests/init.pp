class ntp (
  ...
  $broadcast       = $ntp::params::broadcast,
  $multicastclient = $ntp::params::multicastclient,
  $manycastclient  = $ntp::params::manycastclient,
  $manycastserver  = $ntp::params::manycastserver,
